...
user = 'gberseth'
### Glen: These should be replaced with code that checks for environment variables.
...
envType = 'Ant' ; annotation = 'debug-3tasks-v0' ; tasksFile = 'rad2_quat_v2' ; max_path_length = 200
expertDataLoc = path_to_gmps+'/saved_expert_trajs/ant-quat-v2-3tasks-itr400/'
...
load_policy = log_dir+'debug-3tasks-v0/itr_8.pkl'
#load_policy = None
