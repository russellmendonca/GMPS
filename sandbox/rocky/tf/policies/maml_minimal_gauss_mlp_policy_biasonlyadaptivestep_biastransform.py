...
class MAMLGaussianMLPPolicy(StochasticPolicy, Serializable):
    def __init__(
        ...
        self.input_shape = (None, self.obs_dim + self.latent_dim,)
        ...
        if std_network is not None:
            ...
            if adaptive_std:
                ...
                self.all_params['std_param_stepsize'] = tf.Variable(self.init_flr_full*tf.ones_like(self.all_params['std_param']), name="output_std_param_stepsize")
    ...
    def create_MLP(self, name, output_dim, hidden_sizes,
        ...
        with tf.variable_scope(name):
            for idx, hidden_size in enumerate(hidden_sizes):
                ...
                all_params['W' + str(idx) + '_stepsize'] = tf.Variable(self.init_flr_full*tf.ones_like(W), name="W" + str(idx) + '_stepsize')
                all_params['b' + str(idx) + '_stepsize'] = tf.Variable(self.init_flr_full*tf.ones_like(b), name="b" + str(idx) + '_stepsize')
